...
import { PercentIcon, ArrowUpIcon } from "lucide-react";

interface PrecioFormProps {
  porcentaje: number;
  onChangePorcentaje: (valor: number) => void;
  onVistaPrevia: () => void;
  ...
  productosNombres: (id: string) => string;
  disabled: boolean;
}
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Defina el porcentaje de incremento a aplicar
        </CardDescription>
      </CardHeader>
      <CardContent>
